        ...
        valid: [
            {
                ...
                code: [
                    ...
                    "import { B } from './src/domain'",
                    "import { C } from './src/domain/a'",
                    "import { D } from './src/domain/b'",
                    "import { E } from './src/domain/c'",
                    "import { F } from './src/domain/d'",
                    "import { G } from './src/domain/b/a'",
                    "import { H } from './src/domain/b/b'",
                ].join('\n'),
                options: [{ sort: [{ type: 'group', groups: ['src/utils', 'src/domain'] }, { type: 'depth' }, { type: 'name' }] }],
            },
            {
